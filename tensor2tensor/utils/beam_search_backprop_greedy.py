...
def compute_topk_scores_and_seq(sequences, scores, scores_to_gather, flags,
  ...
  return topk_seq, topk_gathered_scores, topk_flags, topk_gathered_states, alive_final_outputs
...
def beam_search(symbols_to_logits_fn,
  ...
  def grow_alive(curr_seq, curr_scores, curr_log_probs, curr_finished, states, topk_final_outputs):
    """Given sequences and scores, will gather the top k=beam size sequences.
  ...
  def grow_topk(i, alive_seq, alive_log_probs, states, alive_final_outputs):
    ...
    return topk_seq, topk_log_probs, topk_scores, topk_finished, states, topk_final_outputs
  ...
  def inner_loop(i, alive_seq, alive_log_probs, finished_seq, finished_scores,
    ...
    topk_seq, topk_log_probs, topk_scores, topk_finished, states, topk_final_outputs = grow_topk(
        i, alive_seq, alive_log_probs, states, alive_final_outputs)
    alive_seq, alive_log_probs, _, states, alive_final_outputs = grow_alive(
        topk_seq, topk_scores, topk_log_probs, topk_finished, states,
        topk_final_outputs)
    finished_seq, finished_scores, finished_flags, _, finished_final_outputs = grow_finished(
  ...
  return finished_seq, finished_scores, finished_final_outputs
