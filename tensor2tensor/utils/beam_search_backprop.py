...
def beam_search(symbols_to_logits_fn,
  ...
  alive_decoder_logits = tf.expand_dims(
      _expand_to_beam_size(initial_logits, beam_size) , axis=2) # (batch_size, beam_size, 1, vocab_size)
  finished_decoder_logits = tf.zeros(
      common_layers.shape_list(alive_decoder_logits), tf.float32) # (batch_size, beam_size, 1, vocab_size)
  ...
  finished_final_outputs = tf.zeros(common_layers.shape_list(alive_final_outputs),
  ...
  def inner_loop(i, alive_seq, alive_log_probs, finished_seq, finished_scores,
    ...
    alive_seq, alive_log_probs, _, states, alive_decoder_logits, alive_final_outputs = grow_alive(
        ...
        topk_decoder_logits, topk_final_outputs)
  ...
  (_, alive_seq, alive_log_probs, finished_seq, finished_scores,
   finished_flags, _,
   alive_decoder_logits, finished_decoder_logits,
   alive_final_outputs, finished_final_outputs) = tf.while_loop(
       _is_finished,
       inner_loop, [
