...
if is_trans:
    # for trans
    PATH_TRAIN = '/zfs1/hdaqing/saz31/dataset/tf_example/ppdbxu/train.tfrecords.'
    PATH_PREFIX_FEATURES = '/zfs1/hdaqing/saz31/dataset/tmp_trans/ner/features/shard'
else:
    # for wikilarge
    PATH_TRAIN = '/zfs1/hdaqing/saz31/dataset/tf_example/ppdbxu/wiki.tfrecords.'
