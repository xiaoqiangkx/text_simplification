...
if is_trans:
    ...
    PATH_PREFIX_PPDB = '/zfs1/hdaqing/saz31/dataset/tmp_trans/ner/ppdb_addxu/shard'
    PATH_PREFIX_PPDBRULE = '/zfs1/hdaqing/saz31/dataset/tmp_trans/ner/ppdb_rule_addxu/shard'
    PATH_PREFIX_META = '/zfs1/hdaqing/saz31/dataset/tmp_trans/ner/meta_addxu/shard'
    PATH_PREFIX_STRUC = '/zfs1/hdaqing/saz31/dataset/tmp_trans/ner/struc/shard'
else:
    # for wikilarge
    PATH_FEATURES = '/zfs1/hdaqing/saz31/dataset/tmp_wikilarge/ner/features/shard'
    PATH_PREFIX_COMP = '/zfs1/hdaqing/saz31/dataset/tmp_wikilarge/ner/ncomp/shard'
    PATH_PREFIX_SIMP = '/zfs1/hdaqing/saz31/dataset/tmp_wikilarge/ner/nsimp/shard'
    PATH_PREFIX_PPDB = '/zfs1/hdaqing/saz31/dataset/tmp_wikilarge/ner/ppdb_addxu/shard'
    PATH_PREFIX_PPDBRULE = '/zfs1/hdaqing/saz31/dataset/tmp_wikilarge/ner/ppdb_rule_addxu/shard'
    PATH_PREFIX_META = '/zfs1/hdaqing/saz31/dataset/tmp_wikilarge/ner/meta_addxu/shard'
    PATH_PREFIX_STRUC = '/zfs1/hdaqing/saz31/dataset/tmp_wikilarge/ner/struc/shard'
